...
👉 <a href="https://ghproxy.com/https://github.com/SonicCloudOrg/sonic-agent/releases/download/v2.3.2/sonic-agent-v2.3.2-linux_x86.zip" target="_blank">sonic-agent-v2.3.2-linux_x86.zip</a>

👉 <a href="https://ghproxy.com/https://github.com/SonicCloudOrg/sonic-agent/releases/download/v2.3.2/sonic-agent-v2.3.2-linux_x86_64.zip" target="_blank">sonic-agent-v2.3.2-linux_x86_64.zip</a>

👉 <a href="https://ghproxy.com/https://github.com/SonicCloudOrg/sonic-agent/releases/download/v2.3.2/sonic-agent-v2.3.2-linux_arm64.zip" target="_blank">sonic-agent-v2.3.2-linux_arm64.zip</a>

:::

::: info Macosx

👉 <a href="https://ghproxy.com/https://github.com/SonicCloudOrg/sonic-agent/releases/download/v2.3.2/sonic-agent-v2.3.2-macosx_x86_64.zip" target="_blank">sonic-agent-v2.3.2-macosx_x86_64.zip</a>

👉 <a href="https://ghproxy.com/https://github.com/SonicCloudOrg/sonic-agent/releases/download/v2.3.2/sonic-agent-v2.3.2-macosx_arm64.zip" target="_blank">sonic-agent-v2.3.2-macosx_arm64.zip</a>

:::

::: info Windows

👉 <a href="https://ghproxy.com/https://github.com/SonicCloudOrg/sonic-agent/releases/download/v2.3.2/sonic-agent-v2.3.2-windows_x86.zip" target="_blank">sonic-agent-v2.3.2-windows_x86.zip</a>

👉 <a href="https://ghproxy.com/https://github.com/SonicCloudOrg/sonic-agent/releases/download/v2.3.2/sonic-agent-v2.3.2-windows_x86_64.zip" target="_blank">sonic-agent-v2.3.2-windows_x86_64.zip</a>
...
1. 配置国内加速镜像源（推荐）
2. <a href="https://ghproxy.com/https://github.com/SonicCloudOrg/sonic-agent/releases/download/v2.3.2/docker-compose-zh.yml" target="_blank">点击这里</a> 下载docker-compose-zh.yml后执行以下指令直接使用加速镜像（不推荐，加速源可能出现不稳定或网络波动，后续down的时候需要docker-compose -f docker-compose-zh.yml down）
```bash
