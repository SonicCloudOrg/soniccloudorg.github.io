...
>
> 2. <a href="https://sonic-cloud.sonic-download.workers.dev/https://github.com/SonicCloudOrg/sonic-agent/releases/download/v2.0.0-beta/docker-compose.yml" target="_blank">点击这里</a> 下载最新的docker-compose.yml，参考注释修改里面的内容。（如果你是非中国大陆用户，请 <a href="https://sonic-cloud.sonic-download.workers.dev/https://github.com/SonicCloudOrg/sonic-agent/releases/download/v2.0.0-beta/docker-compose2.yml" target="_blank">点击这里</a> 下载）
>
> 3. 执行以下指令（自行根据提示更改参数）。
>
> ```
