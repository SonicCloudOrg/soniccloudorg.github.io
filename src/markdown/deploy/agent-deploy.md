...
>
> 2. <a href="https://gh.flyinbug.top/gh/https://github.com/SonicCloudOrg/sonic-agent/releases/download/v2.0.3/docker-compose.yml" target="_blank">点击这里</a> 下载最新的docker-compose.yml，参考注释修改里面的内容。（如果你是非中国大陆用户，请 <a href="https://gh.flyinbug.top/gh/https://github.com/SonicCloudOrg/sonic-agent/releases/download/v2.0.3/docker-compose2.yml" target="_blank">点击这里</a> 下载）
>
> 3. 执行以下指令（自行根据提示更改参数）。
>
> ```
...
> > **Linux:**
> > 
>  > 👉<a href="https://gh.flyinbug.top/gh/https://github.com/SonicCloudOrg/sonic-agent/releases/download/v2.0.3/sonic-agent-v2.0.3-linux_x86.zip" target="_blank">sonic-agent-v2.0.3-linux_x86.zip</a>
>  >
>  > 👉<a href="https://gh.flyinbug.top/gh/https://github.com/SonicCloudOrg/sonic-agent/releases/download/v2.0.3/sonic-agent-v2.0.3-linux_x86_64.zip" target="_blank">sonic-agent-v2.0.3-linux_x86_64.zip</a>
>  > 
>  > 👉<a href="https://gh.flyinbug.top/gh/https://github.com/SonicCloudOrg/sonic-agent/releases/download/v2.0.3/sonic-agent-v2.0.3-linux_arm64.zip" target="_blank">sonic-agent-v2.0.3-linux_arm64.zip</a>
> >
> > **Macosx:**
> >
>  > 👉<a href="https://gh.flyinbug.top/gh/https://github.com/SonicCloudOrg/sonic-agent/releases/download/v2.0.3/sonic-agent-v2.0.3-macosx_x86_64.zip" target="_blank">sonic-agent-v2.0.3-macosx_x86_64.zip</a>
>  > 
>  > 👉<a href="https://gh.flyinbug.top/gh/https://github.com/SonicCloudOrg/sonic-agent/releases/download/v2.0.3/sonic-agent-v2.0.3-macosx_arm64.zip" target="_blank">sonic-agent-v2.0.3-macosx_arm64.zip</a>
> >
> > **Windows:**
> >
>  > 👉<a href="https://gh.flyinbug.top/gh/https://github.com/SonicCloudOrg/sonic-agent/releases/download/v2.0.3/sonic-agent-v2.0.3-windows_x86.zip" target="_blank">sonic-agent-v2.0.3-windows_x86.zip</a>
>  > 
>  > 👉<a href="https://gh.flyinbug.top/gh/https://github.com/SonicCloudOrg/sonic-agent/releases/download/v2.0.3/sonic-agent-v2.0.3-windows_x86_64.zip" target="_blank">sonic-agent-v2.0.3-windows_x86_64.zip</a>
> 
