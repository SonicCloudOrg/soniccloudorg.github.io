...
👉[Java Doc](https://s01.oss.sonatype.org/service/local/repositories/releases/archive/io/github/soniccloudorg/sonic-driver-core/1.1.23/sonic-driver-core-1.1.23-javadoc.jar/!/index.html)
...
API文档可前往：👉[Java Doc](https://s01.oss.sonatype.org/service/local/repositories/releases/archive/io/github/soniccloudorg/sonic-driver-core/1.1.23/sonic-driver-core-1.1.23-javadoc.jar/!/index.html)
...
```groovy
implementation 'io.github.soniccloudorg:sonic-driver-core:1.1.23'
```
